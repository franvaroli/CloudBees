...
public class TicketAPI {
    ...
    public ResponseEntity<Receipt> buyTicket(@Parameter(description = "Train Id") Long idTrain,
                                             @Parameter(description = "User Id") Long idUser) {
        var receipt = ticketService.buyTicket(idTrain, idUser);
        return new ResponseEntity<>(receipt, HttpStatus.OK);
    }

    @GetMapping(value = "/receipt")
    public ResponseEntity<List<Receipt>> getReceipts(@Parameter(description = "Train Id") Long idTrain,
                                                     @Parameter(description = "User Id") Long idUser) {
    ...
    public ResponseEntity<List<Receipt>> getReceiptsBySection(@Parameter(description = "Train Id") Long idTrain,
    ...
    public ResponseEntity<HttpStatus> deleteTicket(@Parameter(description = "Ticket Id") Long idTicket) {
        ticketService.deleteTicket(idTicket);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @PutMapping(value = "/changeSeat")
    public ResponseEntity<Receipt> changeSeat(@Parameter(description = "Ticket Id") Long idTicket) {
